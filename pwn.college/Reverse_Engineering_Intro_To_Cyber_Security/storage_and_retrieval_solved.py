...
def build_data():
	...
	data += create_sprite(2, 74, 1, b"\x2d"*74)
	data += render_sprite(1, 255, 255, 255, 76, 24)
	data += render_sprite(2, 255, 255, 255, 1, 24)
	data += render_sprite(1, 255, 255, 255, 75, 24)

	# Right Line
	data += create_sprite(3, 1, 22, b"\x7c"*22)
	data += render_sprite(3, 255, 255, 255, 75, 1)

	# Left Line
	data += render_sprite(3, 255, 255, 255, 76, 1)

	# Bottom Line
	data += create_sprite(4, 1, 1, b"\x27")
	data += render_sprite(4, 255, 255, 255, 76, 23)
	data += render_sprite(2, 255, 255, 255, 1, 23)
	data += render_sprite(4, 255, 255, 255, 75, 23)
	...
	data += render_sprite(5, 255, 0, 0, 23, 10)
	...
	data += render_sprite(6, 0, 255, 0, 30, 9)
	...
	data += render_sprite(7, 0, 0, 255, 36, 9)
	...
	data += render_sprite(8, 128, 128, 128, 45, 9)
